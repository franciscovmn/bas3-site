...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-brand-black to-muted/20 text-foreground border-t border-border">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Chatbots Inteligentes</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Análise de Documentos</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Automação de Processos</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Análise Preditiva</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Como Funciona</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-accent transition-colors">Casos de Uso</a></li>
